    ...
    <div className="min-h-screen bg-slate-50 font-sans flex flex-col">
      ...
      <nav className="flex justify-between items-center px-8 py-5 bg-white shadow-sm border-b border-slate-100">
        ...
        <div>
          ...
          <Link to="/login" className="text-slate-600 font-semibold hover:text-purple-600 mr-6 transition">Log In</Link>
          <Link to="/signup" className="bg-slate-900 text-white px-5 py-2 rounded-lg font-semibold hover:bg-slate-800 transition shadow-md">Sign Up</Link>
        </div>
      </nav>
      ...
      <main className="flex-grow flex flex-col items-center justify-center text-center px-4 py-16">
        ...
        {/* Call to Action Buttons Updated to Links */}
        <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
          <Link to="/signup" className="inline-block text-center bg-gradient-to-r from-teal-400 to-purple-500 text-white px-8 py-3.5 rounded-lg font-bold text-lg hover:opacity-90 transition shadow-lg hover:shadow-purple-500/30">
            I want to Borrow
          </Link>
          <Link to="/signup" className="inline-block text-center bg-white text-slate-800 border border-slate-300 px-8 py-3.5 rounded-lg font-bold text-lg hover:border-purple-400 hover:text-purple-600 transition shadow-sm">
            Start Investing
          </Link>
        </div>
      </main>
